...
const ConBanOne = () => {
  return (
    <div>
      <div
        className="relative text-white bg-cover flex flex-col bg-center w-full h-screen"
        style={{ backgroundImage: "url('/concon.png')" }}
      >
        <div className="mx-auto my-auto flex flex-col gap-8 items-center text-center">
          ...
          <div className="mx-auto">
            <p>
              Phone No. <a href="tel:+919136114754">+91 9136114754</a>
            </p>
            <p>
              Phone No. <a href="tel:+919930752917">+91 9930752917</a>
            </p>
            <p>
              Email-{" "}
