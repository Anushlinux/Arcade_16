        ...
        <div className="flex flex-col lg:flex-row items-center justify-center mt-8 sm:mt-10 md:mt-12 lg:mt-16 gap-8 lg:gap-16 xl:gap-24">
          <div className="flex flex-col gap-4 w-full max-w-md">
            ...
            <div className="flex items-center justify-center gap-4">
              <button
                className={`flex flex-row border-2 items-center justify-center border-[#E79700] p-2 w-full sm:w-1/2 md:w-1/3 mx-auto ${
          ...
          <div className="flex flex-col gap-4 text-xl sm:text-2xl md:text-3xl mt-8 lg:mt-0">
            <p>
              <a href="mailto: info@astravantrealty.com">
                info@astravantrealty.com
              </a>
            </p>
            <p>
              <a href="tel:+919136114754">+91 9136114754</a>
            </p>
            <p>
              <a href="tel:+919930752917">+91 9930752917</a>
            </p>
            <p>
              E - Wing - 309, Crystal Plaza, Opposite Infiniti Mall, Andheri
              Link Road, Andheri West, Mumbai - 400 053
            </p>
            <div className="flex flex-row gap-4 justify-center lg:justify-start">
              <a
                href="https://www.instagram.com/astravant.realty?igsh=MTRlOHhlN2pzYXdyeg=="
                target="_blank"
